...
// Print program description
    ...
    for (tank = 1; tank <= 3; tank = tank + 1, gal = 0, miles = 0, mpg = 0) // For Loop statements
    {
        ...
        scanf  ("%f", &miles);
        totalMiles = totalMiles + miles; // Accumulator to store total miles for overall average miles per gallon
        totalGallons = totalGallons + gal; // Accumulator to store total gallons for overall average miles per gallon
        mpg = miles / gal;
