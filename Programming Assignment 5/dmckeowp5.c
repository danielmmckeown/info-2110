/* ---
Program File:  dmckeowp5c
Author: Daniel McKeown
Date: 3 Apr 2022
Assignment: #5
Objective: This program allows a user to perform some simple banking transactions.
--- */
...
// Function "get_num_deposits" asks user for how many deposits they will be entering and returns the value to main
...
// Function "get_num_withdrawals" asks user for how many withdrawals they will be entering and returns the value to main
...
} // End "get_num_withdrawal" function
...
// Define current balance variable
...
// Prompt user for withdrawal amounts
	...
	current_balance -= withdrawals[x]; // Update "current_balance" variable
